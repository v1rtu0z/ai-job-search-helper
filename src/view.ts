...
export const allSections = [
    els.analysisContent, els.userDetailsSection, els.instructionDisplay, els.outputSection,
    ...
    els.generateCoverLetterBtn, els.downloadCoverLetterBtn, els.retryBtn, els.apiKeySection,
